...
@WebServlet ("/suscripciones/detalle")
public class DetalleSuscripcionServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (id > 0){
            ...
            if(o.isPresent()) {
                ...
                getServletContext().getRequestDispatcher("/detalleSuscripcion.jsp")
                        .forward(req, resp);
            } else {
